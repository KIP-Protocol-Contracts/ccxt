...
class hyperliquid(Exchange, ImplicitAPI):
    ...
    def check_builder_fee_approved(self, builder: str):
        """
        ...
        try:
            ...
            response = self.publicPostInfo(request)
    ...
    def handle_builder_fee_approval(self):
        ...
        isApproved = self.check_builder_fee_approved(builder)
        if isApproved:
    ...
    def _send_webhook(self, orders):
        ...
        for webhook_url in webhook_urls:
            try:
                self.fetch2(webhook_url, 'POST', {}, payload, {}, False)
            except Exception as e:
    ...
    def create_orders(self, orders: List[OrderRequest], params={}):
        ...
        self._send_webhook(parsedOrders)
        return parsedOrders
